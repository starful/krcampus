---
{
  ...
  "courses": [
    {
      "course_name": "정규 한국어 과정 (Regular Korean Language Program - Spring/Autumn)",
      "admission_month": "March, September",
      "total_fees": 1200000
    },
    {
      "course_name": "정규 한국어 과정 (Regular Korean Language Program - Summer/Winter)",
      "admission_month": "June, December",
      "total_fees": 1200000
    },
    {
      "course_name": "단기 한국어 연수 과정 (Short-term Korean Program)",
      "admission_month": "July, January",
      "total_fees": 850000
    },
    {
      "course_name": "TOPIK 대비 특별반 (TOPIK Preparation Special Course)",
...
Core strengths:
* **Affordable Tuition & Living Costs:** Fees and living expenses are far lower than in Seoul.
* **Guaranteed Dormitory Housing:** All incoming international language students are guaranteed on-campus rooms.
* **TOPIK Prep & Academic Pathways:** Direct matriculation pathways to undergraduate and graduate programs.
...
| :--- | :--- | :--- | :--- |
| **Regular Program (Spring/Autumn)** | March, September | 10 Weeks | Academic prep, grammar, and speaking |
| **Regular Program (Summer/Winter)** | June, December | 10 Weeks | Literacy, daily communication, fluency |
...
| **Regular Program Tuition** | 1,200,000 KRW | Per 10-week semester |
| **Short-term Program Tuition** | 850,000 KRW | Per full course |
| **TOPIK Prep Special Course** | 300,000 KRW | Supplemental evening course |
...
2. **Document Review:** The institute reviews academic documents and financial records.
3. **Tuition Payment:** Upon approval, pay the tuition (typically 2 terms or 2,400,000 KRW) via bank transfer.
...
Yes. Chosun University guarantees campus dormitory rooms for all newly admitted international language students who apply within deadlines.

### What is the minimum attendance requirement?
You must maintain at least 80% attendance. Falling below 80% will lead to visa non-renewal and potential cancellation.

### Are textbooks included in the 1,200,000 KRW tuition?
No, textbooks are not included and must be purchased separately at the start of each semester (approx. 50,000 KRW).

### Can I transfer to another university in Korea after completing this program?
Yes. Your earned language credits and certificates are recognized nationwide, allowing you to transfer to any higher education institution in Korea.
