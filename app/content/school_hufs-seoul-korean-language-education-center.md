---
{
  ...
  "courses": [
    {
      "course_name": "Regular Intensive Program (정규과정)",
    ...
    {
      "course_name": "Evening Practical Program (야간실용과정)",
  ...
  "title": "Hankuk University of Foreign Studies (HUFS) Korean Language Education Center, Seoul Campus",
  "tuition": {
...
*   **Speaking-Focused Curriculum:** Emphasizes real-life conversation, interactive role-plays, and practical speech drills.
*   **Korean Buddy Program:** Pairs international language students with local HUFS undergraduates for practice and cultural integration.
*   **On-campus Dormitory:** On-campus and near-campus housing options prioritized for KLEC students.
...
| :--- | :--- | :--- | :--- | :--- |
| **Regular Intensive Program (정규과정)** | March, June, September, December | 10 Weeks | 20 Hours | Mon–Fri (09:00–13:00 or 13:10–17:00) |
| **Short-term Program (단기과정)** | January, August | 3 Weeks | 20 Hours | Mon–Fri (09:00–13:00) |
| **Evening Practical Program (야간실용과정)** | March, September | 10 Weeks | 7.5 Hours | Mon, Tue, Thu (19:00–21:30) |

*   **Regular Intensive Program:** Features a 6-level structured curriculum from Beginner (Level 1) to Advanced (Level 6). Each term provides 200 hours of intensive classroom training.
...
| :--- | :--- | :--- | :--- | :--- |
| **Regular Intensive** | 60,000 | 1,730,000 | 60,000 | 1,850,000 |
| **Short-term** | Waived | 1,050,000 | Included | 1,050,000 |
| **Evening Practical** | 60,000 | 920,000 | 50,000 | 1,030,000 |
...
1. **Online Application:** Upload passport photo page, highest graduation certificate (apostilled/consular-verified), and a bank certificate showing $10,000+ USD on the HUFS KLEC portal.
2. **Document Screening:** The administrative office reviews the portfolio (takes 2–3 weeks).
3. **Invoice Payment:** Pay the tuition and registration fees via international wire transfer upon approval.
...
All new students take a mandatory written and oral placement test. Absolute beginners can opt-out and begin directly at Level 1.

### Is health insurance included in the tuition fee?
No. All international students must join the National Health Insurance Service (NHIS) after registering their ARC, costing around 70,000 KRW per month.

### Is there a refund policy if my visa is denied?
Yes. If your visa is rejected, HUFS will issue a full tuition refund if proof is submitted before classes start. The 60,000 KRW application fee is non-refundable.

### How do I apply for the Korean Buddy Program?
Applications open online before each term begins. Spot allocation is competitive, with priority given to Regular Intensive Program students.
