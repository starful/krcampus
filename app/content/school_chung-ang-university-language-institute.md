---
{
  ...
  "title": "Chung-Ang University Language Institute",
  "tuition": {
...
| :--- | :--- | :--- | :--- | :--- |
| **Regular Program** | March, June, Sept, Dec | 10 Weeks | 20 Hours | Mon-Fri (09:00-13:00 / 13:30-17:30) |
| **Short-term Intensive** | August | 3 Weeks | 15 Hours | Mon-Fri (09:00-13:00) + Cultural days |
| **Evening Program** | March, September | 10 Weeks | 6 Hours | Tue, Thu (19:00-21:50) |
| **TOPIK Prep** | April, October | 4-8 Weeks | Varies | Evening / Weekend schedules |

* **Regular Korean Language Program:** Covers Levels 1 to 6. Focuses on speaking, listening, reading, and writing. Includes cultural exchange programs and activities each semester.
* **Short-term Intensive Korean Program:** A highly intensive 3-week course targeting rapid conversation skills and cultural discovery during the summer.
...
| :--- | :--- | :--- | :--- | :--- |
| **Application Fee** | 100,000 KRW | 50,000 KRW | 50,000 KRW | N/A |
| **Tuition (Per Term)** | 1,700,000 KRW | 1,000,000 KRW | 850,000 KRW | 350,000 KRW |
| **Textbooks (Est.)** | 50,000 KRW | Included | 40,000 KRW | 30,000 KRW |
| **Insurance (Est.)** | 60,000 KRW | N/A | Optional | N/A |
...
### Application Steps:
1. **Submit Application:** Complete the online form and upload required academic and financial records.
2. **Document Evaluation:** CAU conducts a screening process (takes 2–3 weeks).
3. **Tuition Payment:** Once accepted, pay the invoice amount through international bank wire.
4. **Standard Admission Letter:** CAU issues the physical Certificate of Admission (COA) required for the visa.
5. **Visa Application:** Present the COA and financial documents to the nearest Korean Consulate.

### Required Documents:
* High school graduation certificate (or higher), apostilled or consular-verified.
...
* **Room Types:** Double (2-person) and Quad (4-person) rooms.
* **Amenities:** Fitness center, study lounges, self-service laundry, convenience stores, and dining halls.
* **Pricing:** Ranges between 1,000,000 KRW and 1,500,000 KRW per 10-week term. 
* **Availability:** Priority is given to new foreign arrivals. Space is limited, making early application necessary.
...
### How does the level placement test work?
All incoming students must take an online or on-site written and oral placement test. Absolute beginners who do not know Hangeul can skip the test and enroll directly in Level 1.

### Are dormitory rooms guaranteed for all language students?
No. Rooms are allocated on a first-come, first-served basis. If you do not secure an on-campus spot, the school office provides resources to find local off-campus options like Goshiwons or shared apartments.
