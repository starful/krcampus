---
{
  ...
  "faculties": [
    ...
    "College of Rail Transportation",
    "College of Convergence Technology"
  ],
  "features": [
    "The only national university in South Korea specializing in transportation, logistics, and railway engineering.",
    "Highly affordable tuition rates as a public/national institution with generous scholarships for international students.",
    "Multi-campus network across Chungju, Jeungpyeong, and Uiwang (Railway specialized campus).",
    "Strong industry-university partnerships with Hyundai Rotem, KORAIL, and leading tech companies."
  ],
...
| :--- | :--- | :--- |
| **Chungju** (Main) | Engineering, Humanities | Colleges of Engineering, Humanities & Social Sciences, Convergence Technology |
| **Jeungpyeong** | Health, Bio Sciences | College of Health & Life Sciences |
| **Uiwang** | Railway & Mobility | College of Rail Transportation |

### Core Colleges:
* **College of Engineering:** Focuses on mechanical, civil, and chemical engineering with practical laboratory funding.
* **College of Rail Transportation (Uiwang Campus):** Located near Seoul, this is Korea’s premier center for railway studies, focusing on rolling stock and operations.
* **College of Convergence Technology:** Prepares students for AI, big data, and smart design.
...
| Fee Category | Cost per Semester (Est.) | Cost per Year (Est.) | Notes |
| :--- | :--- | :--- | :--- |
| **Admission Fee** | KRW 0 | KRW 0 | Waived for all students |
| **Tuition Range** | KRW 1,700,000 - 2,100,000 | KRW 3,400,000 - 4,200,000 | Varies by major |
| **Average Tuition** | **KRW 1,900,000** | **KRW 3,800,000** | Institutional average |
| **Dorm & Meals** | KRW 1,200,000 | KRW 2,400,000 | Includes room & dining |

### International Scholarships
* **Freshman Scholarship:** Based on language proficiency (TOPIK 3+ or IELTS 6.0+), offering 30% to 100% tuition waivers for the first semester.
...
### Key Requirements:
* **Academics:** Verified high school graduation certificate (undergraduate) or bachelor's degree (graduate).
* **Language:** TOPIK Level 3+ for Korean tracks; TOEFL iBT 80 / IELTS 6.0+ for selected English graduate tracks.
* **Financial Proof:** Bank balance certificate of at least USD 16,000 to USD 18,000 to satisfy visa requirements (estimated).

### Application Steps:
1. **Online Portal:** Complete the application form.
2. **Document Submission:** Mail physical apostilled documents to the Office of International Affairs.
...
* **Jeungpyeong Campus (Health & Bio):** A green, quiet campus ideal for concentration and bio-science research.
...
### Does KNUT offer airport pickup?
Yes. The International Office organizes free airport shuttle buses from Incheon International Airport (ICN) at the start of each semester for incoming international students.

### How close is the main campus in Chungju to Seoul?
Chungju is about 1.5 to 2 hours south of Seoul. Direct express buses and the high-speed KTX train make travel between Chungju and Seoul fast and convenient.

### What is the estimated monthly cost of living in Chungju?
Living costs are much lower than in Seoul. Students typically need KRW 600,000 to 800,000 per month to cover food, housing, transport, and utilities.

### Are there student clubs for international students?
Yes. KNUT has several international clubs and a Global Supporters program that pairs new students with Korean buddies for administrative support and cultural exchange.

---
*Disclaimer: All figures, tuition fees, and admission requirements provided in this guide are realistic estimates based on current institutional averages and are subject to change. Always verify with the official KNUT Office of International Affairs before applying.*
