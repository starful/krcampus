---
{
  ...
  "courses": [
    ...
    {
      "course_name": "Academic Korean Program (학문 목적 한국어 과정)",
  ...
  "faculties": [],
  "features": [
    "Central Seoul Location (near Namsan & Myeongdong)",
    "TOPIK Prep Classes",
    "On-Campus Dormitory Access",
    "Dongguk University Admission Scholarships",
...
| Program Name | Admission Months | Duration | Hours / Week | Class Time |
| :--- | :--- | :--- | :--- | :--- |
| **Regular Program** | March, June, Sept, Dec | 10 weeks | 20 hours | Mon–Fri (9:00-13:00 / 13:10-17:10) |
| **Short-term** | January, August | 3 weeks | 20 hours | Mon–Fri (9:00-13:00) |
| **Academic Korean** | March, September | 10 weeks | 20 hours | Mon–Fri (Focus on university prep) |
| **TOPIK Prep** | April, October | 6 weeks | 4 hours | Evening or weekend sessions |

### Level Curriculum Focus
*   **Levels 1–2 (Beginner):** Hangul, basic pronunciation, survival vocabulary, and simple everyday sentence structures.
...
| Expense Item | Regular | Short-term | Academic | TOPIK Prep |
| :--- | :--- | :--- | :--- | :--- |
| **Application Fee** | 60,000 | 60,000 | 60,000 | N/A |
| **Tuition (per term)** | 1,700,000 | 1,050,000 | 1,700,000 | 450,000 |
| **Textbooks (approx.)**| 50,000 | Included | 50,000 | 20,000 |
...
1. **Online Application:** Register on the portal and upload academic and financial documents.
2. **Document Screening:** The university evaluates your application (takes 2–3 weeks).
3. **Fee Payment:** Transfer the invoiced tuition and application fees to Dongguk's bank account.
4. **CoA Issuance:** KLI sends you the official Certificate of Admission.
5. **Visa Application:** Submit the CoA and your bank records to your local Korean Embassy.
6. **Orientation:** Travel to Korea, complete a medical screening, take the placement test, and start classes.

### Core Document Checklist
*   **Apostilled Certificate:** High school diploma or university graduation certificate.
...
### Is dormitory housing guaranteed for all new students?
No. Dorm rooms are limited and assigned on a first-come, first-served basis. Apply and pay your deposit as soon as you receive your acceptance letter.

### What is the refund policy if my D-4 visa is rejected?
If the Korean Embassy rejects your visa, Dongguk KLI refunds your tuition in full. The KRW 60,000 application fee is non-refundable.

### Can I transfer from another Korean language school?
Yes. You can transfer your visa. Submit your current transcripts (with at least 80% attendance) and registration certificate to Dongguk KLI before the term begins.

### How does the Korean Buddy Program work?
It pairs you with a Dongguk student to practice Korean, open a bank account, and experience local culture.
