---
{
  ...
  "features": [
    ...
    "Incredibly affordable tuition fees compared to private universities in the capital region.",
    "Comprehensive global support programs, including free Korean language support and cultural excursions.",
    "Strong local industry connections, particularly in AI, automotive technology, and biotechnology in Gwangju."
  ],
...
To ease the transition, CNU provides structured international support:
- **Free Korean Support**: Non-native speakers receive complimentary, structured language training at the Language Education Center.
...
- **College of Business Administration**: AACSB-accredited, ensuring world-class business training.
...
| Fee Category | Chonnam National University (CNU) | Seoul Private Universities |
| :--- | :--- | :--- |
| **Admission Fee** | 0 KRW | ~300,000 KRW |
| **Yearly Tuition (Humanities)** | ~3,400,000 KRW | ~7,500,000 KRW |
| **Yearly Tuition (STEM/AI)** | ~4,600,000 KRW | ~9,500,000 KRW |
| **Average Yearly Tuition** | **~4,100,000 KRW** | **~8,500,000 KRW** |

### International Student Scholarships

| Scholarship Name | Requirements | Benefits |
| :--- | :--- | :--- |
| **Global Scholarship (A)** | TOPIK Level 5/6 or equivalent English | 100% Tuition Waiver (1st Sem) |
| **Global Scholarship (B)** | TOPIK Level 4 or equivalent English | 50% Tuition Waiver (1st Sem) |
...
### Application Steps
1. **Online Application**: Register via the CNU portal (Spring: Sept-Oct; Fall: Mar-Apr).
2. **Document Submission**: Send verified transcripts, certificates, and financial proof ($18,000 USD minimum).
3. **Language Verification**: Submit TOPIK Level 3 or higher, or English scores (TOEFL iBT 80 / IELTS 5.5) for English-track programs.
...
### What is the exact campus address?
The main campus is located at *77 Yongbong-ro, Buk-gu, Gwangju, 61186, South Korea*. Students should contact the Office of International Affairs (OIA) for arrivals.

### Do I need to be fluent in Korean?
No. While Korean language skills open up the widest options, students can apply to English-taught tracks in Business and Engineering using IELTS, TOEFL, or equivalent credentials.

### How modern are the dormitories?
CNU’s dormitories are highly modern and secure, featuring card-key entry, laundry facilities, study lounges, and in-building dining. Single rooms are available upon request.

### What career support does CNU offer?
The Career Development Center provides resume workshops, interview coaching, and job matching with local tech and automotive firms, hosting annual global career fairs.
