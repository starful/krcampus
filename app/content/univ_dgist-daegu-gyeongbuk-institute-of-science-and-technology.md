---
{
  ...
  "features": [
    "Unique Single-Major Undergraduate Curriculum (Convergence Science)",
    "100% Lectures Conducted in English",
    "Generous Scholarship Coverage (Full Tuition Waiver & Monthly Stipends for Qualified Students)",
    "World-class Research Infrastructure and High-Performance Computing (HPC) Center"
  ],
  ...
  "stats": {
    "acceptance_rate": "Estimated 10-15%",
  ...
  "title": "Daegu Gyeongbuk Institute of Science and Technology",
  "tuition": {
...
| Faculty / Department | Key Research Focus Areas |
| :--- | :--- |
| **School of Undergraduate Studies** | Basic Science & Convergence Engineering (Single-Major) |
| **Dept. of Physics and Chemistry** | Advanced Materials, Quantum Dynamics |
| **Dept. of Electrical Engineering & CS** | AI, Robotics, Semiconductors, IoT |
| **Dept. of Robotics & Mechatronics** | Cyber-Physical Systems, Medical Robotics |
| **Dept. of Energy Science & Engineering** | Solar Cells, Battery Technology, Hydrogen Energy |
| **Dept. of Brain Sciences** | Neurodegeneration, Cognitive Neuroscience |
| **Dept. of New Biology** | Systems Biology, Aging Research |
| **Dept. of Interdisciplinary Studies** | Convergence Technologies, Complex Systems |
...
| Expense / Funding Item | Estimated Cost / Semester | Estimated Annual Cost | Remarks / Eligibility |
| :--- | :--- | :--- | :--- |
| **Admission Fee** | 100,000 (One-time) | - | Paid upon entry |
| **Tuition Fee** | 3,500,000 | 7,000,000 | Waived for scholarship recipients |
| **Dormitory Fee** | 800,000 | 1,600,000 | Shared room option (estimated) |
| **DGIST Scholarship** | -3,500,000 | -7,000,000 | Full tuition waiver (merit-based) |
| **Monthly Stipends** | 350,000 to 800,000 | 4,200,000 - 9,600,000 | Varies by program/performance |
...
*   **Academic Transcripts:** Consistently high grades in STEM courses.
*   **Standardized Test Scores (Optional):** SAT, ACT, AP, or equivalent.
*   **English Proficiency:** Minimum score of IELTS 6.5, TOEFL iBT 80, or equivalent.
*   **Letters of Recommendation:** From science or math educators.
*   **Personal Statement:** Focused on research goals and convergence thinking.
...
### What does the "Single-Major" undergraduate curriculum mean?
All undergraduate students enroll without a declared major. Instead of being locked into a single discipline, they learn across all basic sciences and engineering fields, choosing customized research projects in their junior and senior years.

### Are international students guaranteed on-campus housing?
Yes, almost all international students are guaranteed accommodation in modern on-campus dormitories, which are highly subsidized and located within walking distance of all academic buildings.

### What is the average monthly stipend for international students?
Qualified undergraduate students receive about 350,000 KRW per month for living expenses, while graduate researchers can receive between 800,000 and 1,200,000 KRW, depending on laboratory funding.

### Can undergraduate students participate in research projects?
Absolutely. DGIST's Undergraduate Group Research Program (UGRP) is a core part of the curriculum, allowing undergraduate students to lead and participate in actual scientific projects alongside graduate mentors and world-class faculty.
