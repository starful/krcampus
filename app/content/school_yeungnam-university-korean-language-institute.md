---
basic_info:
  address: 280 Daehak-ro, Gyeongsan-si, Gyeongsangbuk-do, Republic of Korea
  capacity: 500
  name_en: Yeungnam University Korean Language Institute
  name_ko: 영남대학교 한국어교육원
category: school
courses:
...
- University and graduate school admission pathways
id: school_yeungnam-university-korean-language-institute
lang: en
layout: school
location:
  lat: 37.5665
...
- Korean cultural experience programs
- University and graduate school admission pathways
thumbnail: /static/images/school_yeungnam-university-korean-language-institute.jpg
title: Yeungnam University Korean Language Institute
tuition:
...
- **Class Hours**: 20 hours per week (Monday to Friday, 09:00 - 13:00)
- **Class Size**: 12–15 students per class for active, personalized interaction.
- **Levels**: Level 1 (Beginner) to Level 6 (Advanced).

| Term | Application Period | Class Duration | Key Focus |
| :--- | :--- | :--- | :--- |
| **Spring (March)** | Nov – Jan | Early March – Mid-May | Foundation grammar & speaking |
| **Summer (June)** | Feb – Apr | Early June – Mid-August | Situational communication |
...
| Fee Category | Amount (KRW) | Description |
| :--- | :--- | :--- |
| **Application Fee** | 100,000 KRW | One-time, non-refundable |
| **Tuition (1 Term)** | 1,300,000 KRW | 10 weeks of regular classes |
| **Tuition (2 Terms)** | 2,600,000 KRW | Minimum tuition required for D-4 visa |
| **Dormitory (approx.)**| 700,000 KRW | Double room for one term (10 weeks) |
| **Textbooks** | 50,000 KRW | Purchased upon arrival at campus bookshop |
...
1. **Submit Application**: Send the application form, passport copy, and 3 photos.
2. **Academic Verification**: Submit your high school (or higher) graduation certificate, which must be Apostilled or Consular-confirmed.
3. **Financial Proof**: Provide a bank balance certificate showing at least $10,000 USD (or equivalent) held for at least 30 days.
4. **Invoice & Payment**: Pay the invoice (2-term tuition of 2,600,000 KRW + 100,000 KRW application fee) via bank transfer.
...
### Q2. Can I get a refund if my visa is rejected?
Yes. If your D-4 visa is officially rejected, submit the rejection notice and refund application. All tuition fees paid will be refunded, except the 100,000 KRW application fee.

### Q3. When can I work part-time?
You can apply for a part-time work permit after 6 months (2 terms) of study, provided your attendance is above 90% and your grades are satisfactory. You may work up to 20 hours per week.

### Q4. Are meals included in the dormitory housing fee?
No, the fee covers room occupancy only. Students can purchase cheap meal tickets at the dorm cafeterias or cook in the communal kitchens.

### Q5. How does the level placement work?
All new students must take an online or on-campus placement test (writing and speaking) before classes start. Absolute beginners skip the test and start directly in Level 1.