...
{
  "layout": "guide",
  "id": "korean-delivery-apps",
  "title": "How to Use Food Delivery Apps in Korea",
  "category": "Culture",
  "tags": [
    "Culture"
  ],
  "description": "Use Baemin, Coupang Eats, and Yogiyo as a student without a Korean ID — payment, addresses, and delivery tips.",
...
1. **Baemin:** The king of delivery in Korea. It has the largest variety of restaurants and features "B-Mart" for grocery deliveries.
2. **Coupang Eats:** Known for speed and excellent English support. If you have a Coupang Rocket Wow membership, you can get free delivery.
3. **Yogiyo:** A reliable alternative that frequently runs massive discount events and franchise promotions.
...
1.  Copy your Korean address from your rental agreement or dorm guide.
2.  Paste it into the search bar of the app.
3.  Select the correct building number, then add your room number (e.g., 301호) in the detailed address line.
4.  Set up rider instructions. Since you might not speak fluent Korean, copy-paste these essential phrases into the "Request to Rider" (라이더 요청사항) box:
