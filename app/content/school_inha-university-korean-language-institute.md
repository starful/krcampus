---
{
  ...
  "courses": [
    {
      "course_name": "정규 과정 (Regular Program)",
      "admission_month": "March, June, September, December",
      "total_fees": 1370000
    },
    {
      "course_name": "단기 연수 과정 (Short-term Intensive Program)",
      "admission_month": "July, August",
      "total_fees": 850000
    },
    {
      "course_name": "TOPIK 대비반 (TOPIK Preparation Class)",
...
*   **Short-term Intensive Program (단기 연수 과정):** Held in summer (July and August), this 3-to-4-week track emphasizes conversational fluency and cultural experiences.
*   **TOPIK Preparation Class (TOPIK 대비반):** Specialized test preparation sessions held in April and October to align with official TOPIK testing dates.
...
| :--- | :--- | :--- |
| **Application Fee** | 60,000 KRW | One-time, non-refundable |
| **Regular Program Tuition** | 1,370,000 KRW | Per 10-week term |
| **Short-term Intensive** | 850,000 KRW | Full course fee |
| **TOPIK Prep Class** | 300,000 KRW | Materials included |
| **Estimated Textbooks** | 60,000 KRW | Purchased per level |
...
2.  **Document Submission:** Provide your high school or university graduation certificate (Apostilled or Consular-verified), academic transcripts, copy of passport, and a bank statement showing at least USD 10,000.
3.  **Document Screening:** The university evaluates qualifications. An online interview is conducted if necessary.
4.  **Tuition Payment:** Upon receiving the invoice, transfer the tuition fees to the designated Inha University bank account.
...
### Is the dormitory guaranteed for all international language students?
Yes, housing is guaranteed for all incoming international students during their first semester, provided they apply and pay the dormitory fee by the deadline.

### How do I transition from the language program to an Inha University degree?
You must pass Level 3 or 4 of the Regular Program or secure an equivalent TOPIK score, then apply via the international admissions track during the university's standard application windows.

### What is the Inha Buddy Program and how do I apply?
The program pairs you with a domestic Inha student to help with local integration. Applications are distributed via email during the orientation week before classes start.

### Are textbooks included in the tuition fee?
No. Textbooks must be purchased separately at the campus bookstore at the beginning of each term, costing approximately 50,000 to 70,000 KRW.
