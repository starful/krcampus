...
* **Affordable Tuition:** Highly competitive pricing due to municipal government funding.
* **Seoul Municipal Government Support:** Generous resources translate directly to low student costs and high-quality programs.
* **Korean Peer Buddy Program:** Pairs international students with Korean UOS undergraduates for natural language practice and cultural exchange.
...
### Table 1: Regular Program Calendar
| Semester | Admission Month | Duration | Hours/Week | Total Hours |
| :--- | :--- | :--- | :--- | :--- |
| **Spring** | March | Mar – May (10 Weeks) | 20 | 200 |
| **Summer** | June | Jun – Aug (10 Weeks) | 20 | 200 |
...
| Item | Cost (KRW) | Refundability & Details |
| :--- | :--- | :--- |
| **Application Fee** | 50,000 | Non-refundable processing fee |
| **Tuition (1 Semester)** | 1,580,000 | Covers 10-week course tuition |
...
1. **Online Application:** Submit the online application form and upload documents before the deadline (typically 10-12 weeks before semester start).
2. **Document Screening:** The UOS admissions committee reviews academic and financial credentials.
3. **Payment:** Once accepted, pay the invoice (application fee + minimum 2 semesters of tuition).
4. **CoA Issuance:** Receive the official Certificate of Admission (CoA) from UOS.
5. **Visa Application:** Present the CoA, passport, and financial documents to the local Korean embassy.
...
### Q2: What happens to my tuition if my visa is rejected?
While the 50,000 KRW application fee is non-refundable, you will receive a full refund of your pre-paid tuition. You must submit the official visa rejection document to the UOS administration.

### Q3: How do I sign up for the Korean Peer Buddy Program?
No pre-registration is required. The institute distributes sign-up forms for the Buddy Program during the mandatory orientation in the first week of classes.

### Q4: Are textbook fees included in the 1,580,000 KRW tuition?
No. You must purchase the designated textbooks at the campus bookstore before classes begin. Textbooks generally cost between 50,000 and 70,000 KRW per level.

### Q5: Can I study for only one semester on a tourist visa?
Yes, you can study for one 10-week term using a K-ETA or a tourist visa. In this case, you only need to pay the application fee and one semester's tuition (1,580,000 KRW).
