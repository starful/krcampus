...
2. **Recommendation Letter:** From a high school academic advisor or science/math teacher.
3. **Official Academic Transcripts:** High school transcripts.
4. **Standardized Test Scores (Optional but highly recommended):** SAT, ACT, AP, IB, GCE A-Level, or national college entrance exam scores.
5. **English Proficiency Test Scores:** TOEFL iBT (83+), IELTS (6.5+), TEPS, or TOEIC scores if the applicant's high school instruction was not entirely in English.
6. **Passport Copy & Certificate of Facts on Class Entry/Exit** (proves non-Korean residency history).